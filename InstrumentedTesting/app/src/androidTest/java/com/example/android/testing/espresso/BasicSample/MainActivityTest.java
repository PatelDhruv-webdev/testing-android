...
public class MainActivityTest {
    ...
    public void validateEditText() {
        ...
        */
        onView(withId(R.id.editTextUserInput)).perform(typeText("Group17"), closeSoftKeyboard());
        onView(withId(R.id.changeTextBt)).perform(click());
        onView(withId(R.id.textToBeChanged)).check(matches(withText("Group17")));
        clearTexts();

        onView(withId(R.id.editTextUserInput)).perform(typeText("Group17"), closeSoftKeyboard());
        onView(withId(R.id.activityChangeTextBtn)).perform(click());
        onView(withId(R.id.show_text_view)).check(matches(withText("Group17")));
        onView(isRoot()).perform(ViewActions.pressBack());
        clearTexts();
